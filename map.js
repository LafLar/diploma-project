mapboxgl.accessToken = 'pk.eyJ1IjoibGFmMWFyZSIsImEiOiJjbGkydjB3ZjkwOGM2M2VvOTBjMmg2czJ2In0.YwwlNCGSIHNhnn8ZsR5AsQ';
    const map = new mapboxgl.Map({
    container: 'map', // Specify the container ID
    style: 'mapbox://styles/mapbox/dark-v10', // Specify which map style to use
    center: [30.52414,50.45003], // Specify the starting position [lng, lat]
